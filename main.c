...
void place_sprite()
{
    ...
    if (sspy > 0)
    {
        ...
        if (walls_down(10, 9) == 0)
        {

            sposy.w += sspy;
        }
        if (walls_down(10, 9) == 1)
        {
            sspy = 0;
        }
   ...
   */
    ...
    while (TRUE)
    {
...

        {
            ...
            if (walls_down_check(10, 10) == 1)
            {
                // printf("%d", walls_down_check(10, 10));
                // sposy.w = sposy.w - 200;
                sspy = -300;
            }
        }
